...
function chooseShot()//Here comes the AI
{
	...
	var testAllerRetour3 = (lastVar7(prev) == lastVar6(prev) && lastVar5(prev) == lastVar4(prev) && lastVar3(prev) == lastVar2(prev) && (lastVar6(prev) != lastVar5(prev) && lastVar3(prev) != lastVar5(prev) && lasVar6(prev) != lastVar3(prev)));
